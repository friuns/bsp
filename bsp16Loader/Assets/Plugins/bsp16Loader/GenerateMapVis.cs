...
public class GenerateMapVis : MonoBehaviour
{
    ...
    #endregion
    MyDictionary<uint, Material> mt = new MyDictionary<uint, Material>(() => new Material(Shader.Find("Diffuse")));
    ...
    GameObject GenerateFaceObject(BSPFace face)
    {
        ...
        if (face.texinfo_id >= 0 && renderlights && face.lightmapOffset < map.lightlump.Length)
        {
            ...
            Material bspMaterial = mt[map.texinfoLump.texinfo[face.texinfo_id].miptex];
